...
contract LimitSetting is DSAuth, DSStop {
    ...
    constructor(
        ...
        // AG: could initialise defaultDelayHoursBuffer or set it via function
        // AG: setSettingDefaultDelayHours(_defaultSettingDelayHours);
    ...
    function setSettingDefaultDelayHours(uint256 _hours) public auth {   // Not used to set delay
